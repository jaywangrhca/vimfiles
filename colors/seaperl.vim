...
elseif &background=='dark' 
  ...
  hi Normal		guifg=#f5deb3	guibg=#2f4f4f	gui=NONE
...
" USER DEFINE START
" For Perl
hi perlRepeat	        guifg=DeepPink	        guibg=NONE	gui=NONE
hi perlConditional	guifg=OrangeRed	        guibg=NONE	gui=NONE
hi perlControl    	guifg=NONE	        guibg=ForestGreen	gui=NONE
hi perlSubName	        guifg=Purple	        guibg=NONE	gui=NONE
hi perlOperator	        guifg=Magenta	        guibg=NONE	gui=NONE
" hi perlVarPlain	        guifg=RosyBrown1	        guibg=NONE	gui=NONE
hi perlVarPlain         guifg=#cc6600	        guibg=NONE	gui=NONE
hi perlStatementStorage guifg=LimeGreen	        guibg=NONE	gui=NONE
hi perlStatementControl guifg=NONE	        guibg=Brown	gui=NONE
hi perlLabel            guifg=NONE	        guibg=DarkSlateBlue	gui=NONE
hi perlHereDoc          guifg=#8eff88	        guibg=NONE	gui=NONE
hi perlMatch            guifg=Gray	        guibg=NONE	gui=NONE
hi perlStatementFlow    guifg=NONE	        guibg=BlueViolet	gui=NONE

" For Ruby
hi rubyRepeat	        guifg=NONE        guibg=Deeppink3	gui=NONE
hi rubyConditional	guifg=NONE         guibg=Cyan4  gui=NONE
hi rubyControl    	guifg=NONE	        guibg=ForestGreen	gui=NONE
" hi rubyFunction	        guifg=Purple	        guibg=NONE	gui=NONE
hi rubyDocumentation          guifg=#8eff88	        guibg=NONE	gui=NONE
hi rubyInterpolation    guifg=Orchid        guibg=NONE	gui=NONE

hi rubyInstanceVariable	guifg=#cc6600 guibg=NONE	gui=NONE
hi rubyClassVariable	guifg=#cc6600 guibg=NONE	gui=NONE
hi rubyGlobalVariable	guifg=#cc6600 guibg=NONE	gui=NONE
" USER DEFINE END
